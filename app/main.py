...
from app.services import (
    air_quality, amenities, area_stats, boe_rate, broadband, brownfield, bus_service, catchment, census_stats, clay_risk, coal_mining, council_finance, flood_re, health_services,
...
async def _full_property_gather(
    ...
    if isinstance(bus_service_result, Exception):
